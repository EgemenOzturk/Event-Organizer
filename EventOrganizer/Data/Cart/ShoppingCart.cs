...
namespace EventOrganizer.Data.Cart
{
    public class ShoppingCart
    {
        ...
        public void AddItemToCart(Event eventt)
        {
            var shoppingCartItem = _context.ShoppingCartItems.FirstOrDefault(n => n.Event.Id == eventt.Id && 
        ...
        {
            var shoppingCarItem = _context.ShoppingCartItems.FirstOrDefault(n => n.Event.Id == Event.Id &&
            n.ShoppingCartId == ShoppingCartId);
